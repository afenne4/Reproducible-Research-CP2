...
---
# Synopsis
In this report we examine the economic and public health consequences of severe 
...
information on fatalities, injuries, and property damage. We narrowed our search
...
## Data Processing
The data is obtained from the NOAA storm database. We first download the file and
then use the read csv function as it can handle .bz2 files. We use stringsAsFactors
= FALSE since we need to clean up the data and it will be easier to do that when
...
Now we can do a quick check of the data to make sure there are the correct number
...
and Injuries which will act as measures of population health. We will begin our 
