...
Looking at this table with all the total fatalities and injuries, there is a wide
range in total fatalities/injuries from single digits to thousands. Based on this
lets use event types that are above the 80 percentile for total fatalities and injuries

```{r Figures for Fatalities and injuries}
...
healthdata %>%
    ...
    labs(y="Total Number of Incidents",
         title = "Total Fatalities and Injuries from Weather")+
