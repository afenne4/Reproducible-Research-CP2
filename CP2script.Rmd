...
alltotal<-merge(healthdata,costdata,by="EVTYPECOND",all=TRUE)
    datatable(alltotal,class="cell-border stripe")

```


This table shows the weather events that result in the most damage to population 
health and the economy. This table is for the interested reader as it offers a 
more exact amount of the costs incurred by weather events.
